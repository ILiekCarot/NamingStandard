...
test("getallthreads", {"getallthreads"}, function()
	assert(typeof(getallthreads()) == "table", "Did not return a table")
	assert(#getallthreads() ~= 0, "Returned a empty table")
	assert(typeof(getallthreads()[1]) == "thread", "Table contains non-thread type")
end)
