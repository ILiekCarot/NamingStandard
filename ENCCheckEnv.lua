...
test("isexecutorclosure", {"checkclosure", "isourclosure"}, function()
	...
	assert(isexecutorclosure(print) == false, "Did not return false for a Game global")
end)
...
test("consolesettitle", {"consolename"}, function()
	consolesettitle("ENC Environment Check")
end)

test("consoleprint", {}, function()
	consoleprint("This is a test console print for the ENC Enviroment Check")
end)
